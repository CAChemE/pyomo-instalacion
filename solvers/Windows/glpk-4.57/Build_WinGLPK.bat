...
set glpkvers=4.57
set glpkjavavers=1.3.0
set glpkclivers=1.1.0
...
%gnuwin32%\wget http://downloads.sourceforge.net/project/glpk-cli/libglpk-cli/libglpk-cli-%glpkclivers%/libglpk-cli-%glpkclivers%.tar.gz
